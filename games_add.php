                ...
                <div class="row">
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-md-6">
                                    <h4 class="card-title">Add News</h4><Br>
                                
                                </div>
                                <div class="col-md-6 text-end">
                                    <a href="news.php"class="btn btn-primary">Back</a>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                        <form action="Backend/Games/add.php" method="POST" enctype="multipart/form-data">
                                <div class="mb-3 row">
