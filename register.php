                                ...
                                <div class="mb-4">
                                    <div class="row">
                                        <div class="col-md-1 my-2">
                                            <label class="ms-5 form-label text-secondary">Captcha </label>
                                        </div>
                                        <div class="col-md-6">
                                            <img class="ms-5" src="Backend/captcha.php" alt="PHP Captcha"> <br>
                                        </div>
                                </div>
                                </div>
                                <div class="mb-4 input-group">
                                    <i class="p-md-3 fa fa-lock"></i>
                                    <input type="text" class="form-control" placeholder="Enter Captcha" name="captcha" required/><br>
                                </div>
                                <div class="mb-4 ms-5 form-check">
                                    <input type="checkbox" class="form-check-input" id="signup-4-Checkbox">
                                    <label class="form-check-label" for="signup-4-Checkbox">I accept Terms and
                                        Conditions</label>
                                </div>
                                <button type="submit" class="ms-5 btn btn-primary" style="width: 96.5%">Create Account</button>
                            </form>
